...
GenerativeConjoint covers the full lifecycle of a conjoint study: survey design, D-optimal design generation, conventional tabular presnetations and AI-generated stimuli (text and images), participant-facing survey delivery, and export of analysis-ready data with live feedback.
It is built for researchers who need full control over their data and infrastructure without commercial licensing costs and simplifies research data management through transparent exports of the data, the stimuli, and the stimuli generating prompts.

<img width="800" height="202" alt="Banner with four images for the care robotics context generated by the conjoint tool." src="https://github.com/user-attachments/assets/8b4a9441-9b03-40fd-8248-2a49f765eace" />
<img width="800" height="214" alt="importance_standalone" src="https://github.com/user-attachments/assets/538142ce-a093-4aa1-a781-91cb653f3146" />
...
```
Brauner, P. (2026). From Prompts to Preferences: An Open-Source Platform for Generative AI-Enhanced Conjoint Analysis. https://arxiv.org/abs/2606.12972
```
---
